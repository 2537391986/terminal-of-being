...
export const ITEM_TEMPLATES = [
  ...
  // ═══════════════════════════════════════════════════════════
  // 非武器装备扩充 (28件新增) — by QoderWork 2026-06-23
  // ═══════════════════════════════════════════════════════════

  // ═══ 白板之握 (gloves/common) ═══
  {
    templateId: "tabula_rasa_gloves",
    name: "白板之握",
    rarity: "common",
    slot: "gloves",
    stageRange: [1, 15],
    baseStats: { aspd: 0.05, luck: 3 },
    effects: [],
    concept: findConcept_provide('tabula_rasa_gloves', {
      id: "tabula_rasa", term: "白板(Tabula Rasa)", termEn: "Tabula Rasa / Blank Slate",
      school: "经验论 / 洛克", field: "哲学",
      summary: "洛克在《人类理解论》中反驳了'天赋观念'论。心灵是一块'白板'——刚出生时上面什么都没有,所有知识都来自经验。经验有两个来源:感觉(对外部世界的感知)和反省(对心灵自身活动的感知)。简单观念像原子一样被感觉写入白板,复杂观念则是心灵对这些简单观念的组合、比较和抽象。",
      origin: "约翰·洛克(John Locke, 1632-1704)在《人类理解论》(1689)中系统阐述了经验主义认识论。'白板'这个比喻可追溯到亚里士多德,洛克将其发展为完整的经验论纲领。",
      influence: "洛克的经验论影响了贝克莱和休谟,并通过休谟唤醒了康德的'独断论迷梦'。同时为启蒙运动的教育乐观主义和现代行为主义提供了哲学基础。",
      misconception: "不是'人完全没有先天差异'——洛克承认人的天赋能力有差异,他否定的是'天赋观念',不是'天赋能力'。",
      designNote: "白板——一切从经验中来。",
    }),
    flavorText: "没有先天的技巧,每一次握拳都是一次新学的经验。",
    dropWeight: 35,
  },

  // ═══ 意志薄弱之握 (gloves/magic) ═══
  {
    templateId: "akrasia_gloves",
    name: "意志薄弱之握",
    rarity: "magic",
    slot: "gloves",
    stageRange: [8, 22],
    baseStats: { critDmg: 0.3, atk: 8, def: -2 },
    effects: [],
    concept: findConcept_provide('akrasia_gloves', {
      id: "akrasia", term: "意志薄弱(Akrasia)", termEn: "Akrasia / Weakness of Will",
      school: "德性伦理学 / 亚里士多德", field: "哲学",
      summary: "亚里士多德分析了一个令人困惑的现象:人知道什么是好的,却不去做——'明知故犯'。理性知道普遍原则,但不知道具体情况——当欲望抓住了具体事物,理性被'暂时遮蔽'了。",
      origin: "亚里士多德在《尼各马可伦理学》第七卷中详细讨论了akrasia。苏格拉底认为'无人有意作恶',亚里士多德论证了苏格拉底错了——人可以知道却做不到。",
      influence: "akrasia在基督教神学中与'原罪'联系(奥古斯丁/保罗);在当代行动哲学和决策理论中仍是核心案例。",
      misconception: "不是'意志不够强'——亚里士多德的要点是:知识在具体情境中被'遮蔽'了。你理性上知道熬夜不好,但深夜时'熬夜的感觉'比'后果'更生动。",
      designNote: "高暴击伤害低防御——冲动的爆发力和代价。",
    }),
    flavorText: "明知该收手,拳头却比思考更快。",
    dropWeight: 30,
  },

  // ═══ 心物二元之掌 (gloves/rare) ═══
  {
    templateId: "cartesian_dualism_gloves",
    name: "心物二元之掌",
    rarity: "rare",
    slot: "gloves",
    stageRange: [15, 30],
    baseStats: { atk: 12, maxMp: 20, crit: 0.04 },
    effects: [],
    concept: findConcept_provide('cartesian_dualism_gloves', {
      id: "cartesian_dualism", term: "心物二元论", termEn: "Cartesian Dualism",
      school: "近代哲学 / 笛卡尔", field: "哲学",
      summary: "笛卡尔在Cogito之后面临一个难题:思维实体(res cogitans)和广延实体(res extensa)如何相互作用？笛卡尔的回答是通过松果腺——但这个答案让后来的哲学家们笑了三百年。心身二元论引发的'心身问题'至今是心灵哲学的核心难题。",
      origin: "笛卡尔在《第一哲学沉思集》第六沉思中区分了思维实体和广延实体,并在《灵魂的激情》(1649)中提出松果腺假说。",
      influence: "心身二元论引发了斯宾诺莎的心物平行论、莱布尼茨的预定和谐,以及赖尔在《心的概念》中的著名批判——'机器中的幽灵'教条。",
      misconception: "不是'灵魂比身体高贵'——笛卡尔的二元是实体层面的形上学划分,不是价值判断。",
      designNote: "心灵和身体的二元分裂——物理力量和魔法容量的双重属性。",
    }),
    flavorText: "手是物质的,握拳的意志是精神的——它们在这双掌中勉强统一。",
    dropWeight: 25,
  },

  // ═══ 隐德莱希之拳 (gloves/epic) ═══
  {
    templateId: "entelechy_gloves",
    name: "隐德莱希之拳",
    rarity: "epic",
    slot: "gloves",
    stageRange: [28, 45],
    baseStats: { atk: 18, aspd: 0.08, crit: 0.05 },
    effects: [{"type":"on_hit","chance":0.08,"effect":"aspd_buff","value":0.15,"duration":3,"description":"8% 概率击中后攻速 +15%(3秒)"}],
    concept: findConcept_provide('entelechy_gloves', {
      id: "entelechy", term: "隐德莱希(Entelechy)", termEn: "Entelechy",
      school: "古希腊哲学 / 亚里士多德", field: "哲学",
      summary: "亚里士多德用它来描述事物从'潜能'(dynamis)向'现实'(energeia)的实现过程。一颗橡子是'潜在地'的橡树——当它长成橡树时,就实现了它的'隐德莱希':一种内在的目的性。万物都在朝着自己的'完满实现'运动,不需要外部的设计者。",
      origin: "亚里士多德在《物理学》和《形而上学》中发展了潜能/现实的区分。entelecheia是亚里士多德自己造的词:en(在)+ telos(目的)+ echein(拥有)——'在自身中拥有目的'。",
      influence: "潜能/现实的区分在中世纪经院哲学中被广泛运用,在德国观念论中被重新激活,在当代生物学哲学中仍有回响。",
      misconception: "不是'一切都有预定命运'——隐德莱希是内在的目的性,不是外在的命运安排。",
      designNote: "潜能向现实的实现——全面而无短板的属性。",
    }),
    flavorText: "潜能穿过现实的重重阻碍,在终点实现了自己。",
    dropWeight: 12,
  },

  // ═══ 辩证法之握 (gloves/legendary) ═══
  {
    templateId: "socratic_dialectic_gloves",
    name: "辩证法之握",
    rarity: "legendary",
    slot: "gloves",
    stageRange: [38, 50],
    baseStats: { crit: 0.1, itemFind: 0.12, critDmg: 0.25 },
    effects: [{"type":"on_crit","effect":"item_find_buff","value":0.2,"duration":5,"description":"暴击后 5 秒内物品发现率 +20%"}],
    concept: findConcept_provide('socratic_dialectic_gloves', {
      id: "socratic_dialectic", term: "辩证法(Dialectic)", termEn: "Socratic Dialectic",
      school: "古希腊哲学 / 苏格拉底-柏拉图", field: "哲学",
      summary: "苏格拉底的方法不是发表长篇大论,而是——提问。他假装一无所知(苏格拉底式的反讽),然后不断追问,一步一步剥去错误的意见,逼近知识。苏格拉底说他的工作像助产婆:不生产真理,只是帮助真理从对话者的心灵中'生出'。",
      origin: "苏格拉底本人没有留下著作,通过柏拉图的对话录流传。柏拉图后期对话中辩证法从'盘问'演变为更系统的'理念论'方法。",
      influence: "辩证法概念经历了剧烈变迁:中世纪成为神学论证的技艺;康德指理性越界时的幻相;黑格尔将其提升为哲学的根本方法(正反合);马克思将其'颠倒'为唯物辩证法。",
      misconception: "不是'辩论技巧'——苏格拉底的辩证法和诡辩家的修辞术完全不同。前者追求真理,后者追求说服。",
      designNote: "追问的力量——暴击和寻宝兼得。",
    }),
    flavorText: "每一拳都是一次追问,追问到最后,宝藏自然显现。",
    dropWeight: 4,
  },

  // ═══ 原子唯物之核 (core/common) ═══
  {
    templateId: "atomism_core",
    name: "原子唯物之核",
    rarity: "common",
    slot: "core",
    stageRange: [1, 15],
    baseStats: { def: 5, maxHp: 25 },
    effects: [],
    concept: findConcept_provide('atomism_core', {
      id: "atomism", term: "原子唯物论", termEn: "Atomism",
      school: "古希腊哲学 / 德谟克利特", field: "哲学",
      summary: "德谟克利特和留基伯提出:万物由不可分割的微小粒子——原子构成。原子在虚空中运动、碰撞、组合,形成我们看到的一切。没有神灵设计、没有目的因、没有灵魂——只有原子和虚空。",
      origin: "留基伯(约公元前5世纪)通常被认为是创始人,学生德谟克利特(约公元前460-370)将其系统化。",
      influence: "伊壁鸠鲁继承并修改了原子论,卢克莱修在《物性论》中传播。近代科学革命中伽桑狄、波义耳和牛顿重新激活了原子论。",
      misconception: "不是'唯物主义就是没有灵魂'——德谟克利特认为灵魂也是由更精细的'灵魂原子'构成。",
      designNote: "纯粹的物质——防御和生命的基石。",
    }),
    flavorText: "一切装备归根结底都是原子的不同排列——这是最基础的那一种。",
    dropWeight: 35,
  },

  // ═══ 中庸之心 (core/magic) ═══
  {
    templateId: "golden_mean_core",
    name: "中庸之心",
    rarity: "magic",
    slot: "core",
    stageRange: [8, 22],
    baseStats: { def: 8, maxHp: 35, atk: 5, luck: 3 },
    effects: [],
    concept: findConcept_provide('golden_mean_core', {
      id: "golden_mean", term: "中庸之道(Golden Mean)", termEn: "Golden Mean / Mesotes",
      school: "伦理学 / 亚里士多德", field: "哲学",
      summary: "亚里士多德提出：美德是两种恶之间的中道。勇敢是怯懦和鲁莽之间的中点；慷慨是吝啬和挥霍之间的中点。但这个中点不是算术平均——需要实践智慧(phronesis)来判断。美德是一种'习性'(hexis)，需要通过反复练习来培养。",
      origin: "亚里士多德在《尼各马可伦理学》第二卷中系统阐述了中道学说。",
      influence: "中道学说影响了阿奎那的德性伦理学、儒家的中庸思想(独立发展但结构惊人相似)，以及当代德性伦理学的复兴。",
      misconception: "不是'凡事取中间值就是美德'——有些行为没有中道，比如谋杀。中道只适用于有程度差异的德性领域。",
      designNote: "平衡的装备——没有极端,没有弱点。",
    }),
    flavorText: "不过度追求任何一项属性,反而获得了全面的坚韧。",
    dropWeight: 30,
  },

  // ═══ 四因之枢 (core/rare) ═══
  {
    templateId: "four_causes_core",
    name: "四因之枢",
    rarity: "rare",
    slot: "core",
    stageRange: [15, 32],
    baseStats: { maxHp: 50, def: 12, atk: 8, crit: 0.04 },
    effects: [],
    concept: findConcept_provide('four_causes_core', {
      id: "four_causes", term: "四因论", termEn: "Four Causes",
      school: "古希腊哲学 / 亚里士多德", field: "哲学",
      summary: "亚里士多德提出完整解释需要四个维度:质料因(材料)、形式因(形态)、动力因(制造者)、目的因(目的)。四因不是四个选项,而是四个不可分割的维度——任何一个缺失,你对事物的理解都是残缺的。",
      origin: "亚里士多德在《物理学》第二卷和《形而上学》中系统阐述。",
      influence: "阿奎那用目的因论证上帝存在;培根批评目的因阻碍科学;康德将目的因重新引入;达尔文用自然选择消除了目的因在自然界的必要性。",
      misconception: "不是'四个原因导致一个结果'——'因'(aitia)更接近'解释维度'而非'因果原因'。",
      designNote: "四重维度的完整属性。",
    }),
    flavorText: "质料、形式、动力、目的——四重因缺一不可。",
    dropWeight: 25,
  },

  // ═══ 隐德莱希之核 (core/epic) ═══
  {
    templateId: "entelechy_core",
    name: "隐德莱希之核",
    rarity: "epic",
    slot: "core",
    stageRange: [28, 45],
    baseStats: { maxHp: 120, def: 18, aspd: 0.06 },
    effects: [{"type":"passive","effect":"hp_regen","value":0.02,"description":"每秒恢复 2% 最大生命值"}],
    concept: findConcept_provide('entelechy_core', {
      id: "entelechy", term: "隐德莱希(Entelechy)", termEn: "Entelechy",
      school: "古希腊哲学 / 亚里士多德", field: "哲学",
      summary: "亚里士多德用它来描述事物从'潜能'(dynamis)向'现实'(energeia)的实现过程。一颗橡子是'潜在地'的橡树——当它长成橡树时,就实现了它的'隐德莱希':一种内在的目的性。万物都在朝着自己的'完满实现'运动,不需要外部的设计者。",
      origin: "亚里士多德在《物理学》和《形而上学》中发展了潜能/现实的区分。entelecheia是亚里士多德自己造的词:en(在)+ telos(目的)+ echein(拥有)——'在自身中拥有目的'。",
    ...
    flavorText: "内在目的已完全实现——生命力充盈如其所是。",
    dropWeight: 12,
  },

  // ═══ 逻各斯之枢 (core/legendary) ═══
  {
    templateId: "logos_core",
    name: "逻各斯之枢",
    rarity: "legendary",
    slot: "core",
    stageRange: [40, 50],
    baseStats: { atk: 30, crit: 0.12, critDmg: 0.3, rarityFind: 0.05 },
    effects: [{"type":"passive","effect":"crit_chain","value":0.15,"description":"连续暴击时,暴击伤害额外 +15%(最多叠3层)"}],
    concept: findConcept_provide('logos_core', {
      id: "logos", term: "逻各斯(Logos)", termEn: "Logos",
      school: "古希腊哲学 / 赫拉克利特", field: "哲学",
      summary: "赫拉克利特以'万物皆流'闻名,但他的哲学中还有更深刻的概念:逻各斯——宇宙内在的理性秩序。对立面在表面上冲突,但逻各斯使它们处于动态平衡中。逻各斯是西方哲学中'理性''逻辑''规律'等概念的远古源头。",
      origin: "赫拉克利特(约公元前535-475)以晦涩箴言著称,现存残篇约130条。",
      influence: "逻各斯在斯多亚学派中被等同于宇宙理性;在《约翰福音》中被等同于基督;在黑格尔哲学中演变为'理性'在历史中的自我展开。'逻辑'(logic)的词源仍指向赫拉克利特。",
      misconception: "不是'万物都有一个解释'——赫拉克利特的逻各斯更像是音乐的和谐比例,不是科学的因果规律。",
      designNote: "秩序的力量——暴击和精准。",
    }),
    flavorText: "宇宙的隐藏秩序在你体内共振——每一击都恰好命中最脆弱的位置。",
    dropWeight: 4,
  },

  // ═══ 怀疑论之面纱 (head/common) ═══
  {
    templateId: "pyrrhonian_head",
    name: "怀疑论之面纱",
    rarity: "common",
    slot: "head",
    stageRange: [1, 15],
    baseStats: { dodge: 0.04, luck: 3, def: 2 },
    effects: [],
    concept: findConcept_provide('pyrrhonian_head', {
      id: "pyrrhonian_skepticism", term: "怀疑论(Pyrrhonism)", termEn: "Pyrrhonian Skepticism",
      school: "古希腊哲学 / 皮浪", field: "哲学",
      summary: "皮浪主义怀疑论主张:对于任何命题,我们都可以提出同等有力的正反论证,因此唯一合理的态度是'悬置判断'(epoché)——不对任何事物做出肯定或否定的断言。悬置判断之后,心灵达到'不动心'(ataraxia)——不再被'这到底是不是真的'所困扰的宁静状态。",
      origin: "皮浪(Pyrrho of Elis, 约公元前360-270)据传随亚历山大大帝远征印度,在那里接触了裸体苦行者的哲学后深受影响。他的学生蒂蒙记录了他的思想,但主要文献来源是后来的塞克斯都·恩皮里库斯的《皮浪主义纲要》。",
      influence: "皮浪主义在文艺复兴时期通过蒙田的'我知道什么？'重新激活,深刻影响了笛卡尔的方法论怀疑(虽然笛卡尔最终要克服怀疑),并成为休谟经验论的重要来源。",
      misconception: "不是'什么都不相信'——皮浪主义者仍然按照习惯、法律和本能生活。他们悬置的是'关于事物本质的理论判断',不是日常行为。",
      designNote: "闪避和运气——不做出判断,所以不会被判断击中。",
    }),
    flavorText: "悬置一切判断,所以不会被任何信念击中。",
    dropWeight: 35,
  },

  // ═══ 中庸之冠 (head/rare) ═══
  {
    templateId: "golden_mean_head",
    name: "中庸之冠",
    rarity: "rare",
    slot: "head",
    stageRange: [15, 32],
    baseStats: { def: 12, maxHp: 40, dodge: 0.04, luck: 4 },
    effects: [],
    concept: findConcept_provide('golden_mean_head', {
      id: "golden_mean", term: "中庸之道(Golden Mean)", termEn: "Golden Mean / Mesotes",
      school: "伦理学 / 亚里士多德", field: "哲学",
      summary: "亚里士多德提出：美德是两种恶之间的中道。勇敢是怯懦和鲁莽之间的中点；慷慨是吝啬和挥霍之间的中点。但这个中点不是算术平均——需要实践智慧(phronesis)来判断。美德是一种'习性'(hexis)，需要通过反复练习来培养。",
      origin: "亚里士多德在《尼各马可伦理学》第二卷中系统阐述了中道学说。",
    ...
    flavorText: "不偏不倚的冠冕——在防御和灵活之间找到了恰切的中点。",
    dropWeight: 25,
  },

  // ═══ 心物二元之盔 (head/epic) ═══
  {
    templateId: "cartesian_dualism_head",
    name: "心物二元之盔",
    rarity: "epic",
    slot: "head",
    stageRange: [28, 45],
    baseStats: { maxMp: 30, crit: 0.08, def: 15, maxHp: 60 },
    effects: [{"type":"on_low_mp","threshold":0.2,"stat":"crit","value":0.15,"description":"MP < 20% 时暴击率 +15%"}],
    concept: findConcept_provide('cartesian_dualism_head', {
      id: "cartesian_dualism", term: "心物二元论", termEn: "Cartesian Dualism",
      school: "近代哲学 / 笛卡尔", field: "哲学",
      summary: "笛卡尔在Cogito之后面临一个难题:思维实体(res cogitans)和广延实体(res extensa)如何相互作用？笛卡尔的回答是通过松果腺——但这个答案让后来的哲学家们笑了三百年。心身二元论引发的'心身问题'至今是心灵哲学的核心难题。",
      origin: "笛卡尔在《第一哲学沉思集》第六沉思中区分了思维实体和广延实体,并在《灵魂的激情》(1649)中提出松果腺假说。",
    ...
    flavorText: "心灵和身体在这顶头盔中并存——交互问题是你自己的事。",
    dropWeight: 12,
  },

  // ═══ 逻各斯之眼 (amulet/magic) ═══
  {
    templateId: "logos_amulet",
    name: "逻各斯之眼",
    rarity: "magic",
    slot: "amulet",
    stageRange: [8, 22],
    baseStats: { crit: 0.05, critDmg: 0.1, luck: 3 },
    effects: [],
    concept: findConcept_provide('logos_amulet', {
      id: "logos", term: "逻各斯(Logos)", termEn: "Logos",
      school: "古希腊哲学 / 赫拉克利特", field: "哲学",
      summary: "赫拉克利特以'万物皆流'闻名,但他的哲学中还有更深刻的概念:逻各斯——宇宙内在的理性秩序。对立面在表面上冲突,但逻各斯使它们处于动态平衡中。逻各斯是西方哲学中'理性''逻辑''规律'等概念的远古源头。",
      origin: "赫拉克利特(约公元前535-475)以晦涩箴言著称,现存残篇约130条。",
    ...
    flavorText: "这只眼睛看到了混沌之下的秩序,于是每一击都更加精准。",
    dropWeight: 30,
  },

  // ═══ 偶因论之坠 (amulet/rare) ═══
  {
    templateId: "occasionalism_amulet",
    name: "偶因论之坠",
    rarity: "rare",
    slot: "amulet",
    stageRange: [15, 32],
    baseStats: { rarityFind: 0.08, luck: 8, itemFind: 0.06 },
    effects: [],
    concept: findConcept_provide('occasionalism_amulet', {
      id: "occasionalism", term: "偶因论", termEn: "Occasionalism",
      school: "理性主义哲学 / 马勒伯朗士", field: "哲学",
      summary: "心灵和身体不能直接相互作用——每一次所谓的'原因'都只是上帝行动的'机缘'(occasion)。你推门,门开了,但推动门的力量并非来自你的手臂,而是上帝借你推门这个'机缘'在那一刻使门移动。",
      origin: "马勒伯朗士(Nicolas Malebranche, 1638-1715)在《真理的探求》(1674)中系统提出。他将笛卡尔的心物二元论推向极端。",
      influence: "影响了莱布尼茨的'预定和谐'理论,间接促成了休谟对因果关系的经验论批判。在现代心灵哲学中仍有回响。",
      misconception: "不是'上帝控制一切'——偶因论说的是因果关系需要实体同质性。",
      designNote: "每次事件都是'偶因'——提升掉落概率。",
    }),
    flavorText: "每次击杀都是一次'偶因'——上帝借这个机缘赐予你更好的装备。",
    dropWeight: 25,
  },

  // ═══ 存在先于本质之坠 (amulet/epic) ═══
  {
    templateId: "sartre_existence_amulet",
    name: "存在先于本质之坠",
    rarity: "epic",
    slot: "amulet",
    stageRange: [32, 48],
    baseStats: { atk: 22, critDmg: 0.25, luck: 8 },
    effects: [{"type":"on_kill","effect":"luck_stack","value":1,"description":"每次击杀永久 +1 运气(本局有效,上限30)"}],
    concept: findConcept_provide('sartre_existence_amulet', {
      id: "existence_precedes_essence", term: "存在先于本质", termEn: "Existence Precedes Essence",
      school: "存在主义 / 萨特", field: "哲学",
      summary: "萨特在《存在主义是一种人道主义》中提出了存在主义的第一原则:存在先于本质。人首先存在于世界中,遭遇自己,在世界中涌现——然后才定义自己。没有上帝赋予的'人性',没有预定的命运。你就是你所做的事的总和。这意味着你是彻底自由的,也是彻底负责任的——'人被判定为自由'。",
      origin: "让-保罗·萨特(Jean-Paul Sartre, 1905-1980)在《存在与虚无》(1943)和《存在主义是一种人道主义》(1946)中系统阐述。这一原则是对传统本质主义(从柏拉图到基督教神学)的根本反转。",
      influence: "存在先于本质深刻影响了加缪的荒谬主义、波伏娃的女性主义('女人不是天生的,而是后天变成的')、法农的反殖民思想,以及当代'自我创造'的文化叙事。",
      misconception: "不是'什么都无所谓'——萨特强调自由意味着绝对责任。你不能说'我就是这样的人'来逃避选择——每一次不选择也是一种选择。",
      designNote: "攻击和运气——行动创造本质,而非等待命运。",
    }),
    flavorText: "你的本质由你的行动定义——每一次击杀都在书写你自己。",
    dropWeight: 10,
  },

  // ═══ 白板之铠 (chest/common) ═══
  {
    templateId: "tabula_rasa_chest",
    name: "白板之铠",
    rarity: "common",
    slot: "chest",
    stageRange: [1, 15],
    baseStats: { def: 6, maxHp: 20 },
    effects: [],
    concept: findConcept_provide('tabula_rasa_chest', {
      id: "tabula_rasa", term: "白板(Tabula Rasa)", termEn: "Tabula Rasa / Blank Slate",
      school: "经验论 / 洛克", field: "哲学",
      summary: "洛克在《人类理解论》中反驳了'天赋观念'论。心灵是一块'白板'——刚出生时上面什么都没有,所有知识都来自经验。经验有两个来源:感觉(对外部世界的感知)和反省(对心灵自身活动的感知)。简单观念像原子一样被感觉写入白板,复杂观念则是心灵对这些简单观念的组合、比较和抽象。",
      origin: "约翰·洛克(John Locke, 1632-1704)在《人类理解论》(1689)中系统阐述了经验主义认识论。'白板'这个比喻可追溯到亚里士多德,洛克将其发展为完整的经验论纲领。",
    ...
    flavorText: "未被刻写的铠甲——经验将在上面留下它的铭文。",
    dropWeight: 35,
  },

  // ═══ 中庸之铠 (chest/rare) ═══
  {
    templateId: "golden_mean_chest",
    name: "中庸之铠",
    rarity: "rare",
    slot: "chest",
    stageRange: [15, 32],
    baseStats: { def: 18, maxHp: 60, dodge: 0.04 },
    effects: [],
    concept: findConcept_provide('golden_mean_chest', {
      id: "golden_mean", term: "中庸之道(Golden Mean)", termEn: "Golden Mean / Mesotes",
      school: "伦理学 / 亚里士多德", field: "哲学",
      summary: "亚里士多德提出：美德是两种恶之间的中道。勇敢是怯懦和鲁莽之间的中点；慷慨是吝啬和挥霍之间的中点。但这个中点不是算术平均——需要实践智慧(phronesis)来判断。美德是一种'习性'(hexis)，需要通过反复练习来培养。",
      origin: "亚里士多德在《尼各马可伦理学》第二卷中系统阐述了中道学说。",
    ...
    flavorText: "不过度防御,也不防御不足——中庸之道的美德之铠。",
    dropWeight: 25,
  },

  // ═══ 原子唯物之甲 (chest/epic) ═══
  {
    templateId: "atomism_chest",
    name: "原子唯物之甲",
    rarity: "epic",
    slot: "chest",
    stageRange: [30, 48],
    baseStats: { def: 30, maxHp: 150 },
    effects: [{"type":"passive","effect":"damage_reduction","value":0.05,"description":"受到物理伤害降低 5%"}],
    concept: findConcept_provide('atomism_chest', {
      id: "atomism", term: "原子唯物论", termEn: "Atomism",
      school: "古希腊哲学 / 德谟克利特", field: "哲学",
      summary: "德谟克利特和留基伯提出:万物由不可分割的微小粒子——原子构成。原子在虚空中运动、碰撞、组合,形成我们看到的一切。没有神灵设计、没有目的因、没有灵魂——只有原子和虚空。",
      origin: "留基伯(约公元前5世纪)通常被认为是创始人,学生德谟克利特(约公元前460-370)将其系统化。",
    ...
    flavorText: "纯粹的物质——没有魔法,没有花哨,只有最致密的原子排列。",
    dropWeight: 12,
  },

  // ═══ 白板之履 (boots/common) ═══
  {
    templateId: "tabula_rasa_boots",
    name: "白板之履",
    rarity: "common",
    slot: "boots",
    stageRange: [1, 15],
    baseStats: { dodge: 0.04, luck: 2, maxHp: 15 },
    effects: [],
    concept: findConcept_provide('tabula_rasa_boots', {
      id: "tabula_rasa", term: "白板(Tabula Rasa)", termEn: "Tabula Rasa / Blank Slate",
      school: "经验论 / 洛克", field: "哲学",
      summary: "洛克在《人类理解论》中反驳了'天赋观念'论。心灵是一块'白板'——刚出生时上面什么都没有,所有知识都来自经验。经验有两个来源:感觉(对外部世界的感知)和反省(对心灵自身活动的感知)。简单观念像原子一样被感觉写入白板,复杂观念则是心灵对这些简单观念的组合、比较和抽象。",
      origin: "约翰·洛克(John Locke, 1632-1704)在《人类理解论》(1689)中系统阐述了经验主义认识论。'白板'这个比喻可追溯到亚里士多德,洛克将其发展为完整的经验论纲领。",
    ...
    flavorText: "未被书写的路径——每一步都是全新的经验。",
    dropWeight: 35,
  },

  // ═══ 辩证法之靴 (boots/rare) ═══
  {
    templateId: "socratic_dialectic_boots",
    name: "辩证法之靴",
    rarity: "rare",
    slot: "boots",
    stageRange: [15, 32],
    baseStats: { dodge: 0.08, luck: 5, aspd: 0.05 },
    effects: [],
    concept: findConcept_provide('socratic_dialectic_boots', {
      id: "socratic_dialectic", term: "辩证法(Dialectic)", termEn: "Socratic Dialectic",
      school: "古希腊哲学 / 苏格拉底-柏拉图", field: "哲学",
      summary: "苏格拉底的方法不是发表长篇大论,而是——提问。他假装一无所知(苏格拉底式的反讽),然后不断追问,一步一步剥去错误的意见,逼近知识。苏格拉底说他的工作像助产婆:不生产真理,只是帮助真理从对话者的心灵中'生出'。",
      origin: "苏格拉底本人没有留下著作,通过柏拉图的对话录流传。柏拉图后期对话中辩证法从'盘问'演变为更系统的'理念论'方法。",
    ...
    flavorText: "不断追问的脚步——每一步都在否定上一步的确定性。",
    dropWeight: 25,
  },

  // ═══ 怀疑论之靴 (boots/epic) ═══
  {
    templateId: "pyrrhonian_boots",
    name: "怀疑论之靴",
    rarity: "epic",
    slot: "boots",
    stageRange: [30, 48],
    baseStats: { dodge: 0.15, luck: 10, rarityFind: 0.06 },
    effects: [{"type":"on_dodge","effect":"luck_buff","value":5,"duration":3,"description":"闪避后 3 秒内运气 +5"}],
    concept: findConcept_provide('pyrrhonian_boots', {
      id: "pyrrhonian_skepticism", term: "怀疑论(Pyrrhonism)", termEn: "Pyrrhonian Skepticism",
      school: "古希腊哲学 / 皮浪", field: "哲学",
      summary: "皮浪主义怀疑论主张:对于任何命题,我们都可以提出同等有力的正反论证,因此唯一合理的态度是'悬置判断'(epoché)——不对任何事物做出肯定或否定的断言。悬置判断之后,心灵达到'不动心'(ataraxia)——不再被'这到底是不是真的'所困扰的宁静状态。",
      origin: "皮浪(Pyrrho of Elis, 约公元前360-270)据传随亚历山大大帝远征印度,在那里接触了裸体苦行者的哲学后深受影响。他的学生蒂蒙记录了他的思想,但主要文献来源是后来的塞克斯都·恩皮里库斯的《皮浪主义纲要》。",
    ...
    flavorText: "不做出判断的脚步——你无法击中一个拒绝被定位的人。",
    dropWeight: 12,
  },

  // ═══ 偶因之石 (charm/common) ═══
  {
    templateId: "occasionalism_charm",
    name: "偶因之石",
    rarity: "common",
    slot: "charm",
    stageRange: [1, 15],
    baseStats: { itemFind: 0.04, luck: 2 },
    effects: [],
    concept: findConcept_provide('occasionalism_charm', {
      id: "occasionalism", term: "偶因论", termEn: "Occasionalism",
      school: "理性主义哲学 / 马勒伯朗士", field: "哲学",
      summary: "心灵和身体不能直接相互作用——每一次所谓的'原因'都只是上帝行动的'机缘'(occasion)。你推门,门开了,但推动门的力量并非来自你的手臂,而是上帝借你推门这个'机缘'在那一刻使门移动。",
      origin: "马勒伯朗士(Nicolas Malebranche, 1638-1715)在《真理的探求》(1674)中系统提出。他将笛卡尔的心物二元论推向极端。",
    ...
    flavorText: "每次击杀都是一个'偶因'——运气从每一次机缘中涌现。",
    dropWeight: 35,
  },

  // ═══ 辩证法之玉 (charm/rare) ═══
  {
    templateId: "socratic_dialectic_charm",
    name: "辩证法之玉",
    rarity: "rare",
    slot: "charm",
    stageRange: [15, 32],
    baseStats: { itemFind: 0.1, rarityFind: 0.06, maxMp: 12 },
    effects: [],
    concept: findConcept_provide('socratic_dialectic_charm', {
      id: "socratic_dialectic", term: "辩证法(Dialectic)", termEn: "Socratic Dialectic",
      school: "古希腊哲学 / 苏格拉底-柏拉图", field: "哲学",
      summary: "苏格拉底的方法不是发表长篇大论,而是——提问。他假装一无所知(苏格拉底式的反讽),然后不断追问,一步一步剥去错误的意见,逼近知识。苏格拉底说他的工作像助产婆:不生产真理,只是帮助真理从对话者的心灵中'生出'。",
      origin: "苏格拉底本人没有留下著作,通过柏拉图的对话录流传。柏拉图后期对话中辩证法从'盘问'演变为更系统的'理念论'方法。",
    ...
    flavorText: "不断追问的玉石——真理(和装备)在反复诘问中浮现。",
    dropWeight: 25,
  },

  // ═══ 意志薄弱之石 (charm/epic) ═══
  {
    templateId: "akrasia_charm",
    name: "意志薄弱之石",
    rarity: "epic",
    slot: "charm",
    stageRange: [28, 45],
    baseStats: { crit: 0.12, critDmg: 0.2, def: -4 },
    effects: [{"type":"on_crit","effect":"self_damage","value":0.03,"description":"暴击时自身受到 3% 最大生命伤害(意志薄弱的代价)"}],
    concept: findConcept_provide('akrasia_charm', {
      id: "akrasia", term: "意志薄弱(Akrasia)", termEn: "Akrasia / Weakness of Will",
      school: "德性伦理学 / 亚里士多德", field: "哲学",
      summary: "亚里士多德分析了一个令人困惑的现象:人知道什么是好的,却不去做——'明知故犯'。理性知道普遍原则,但不知道具体情况——当欲望抓住了具体事物,理性被'暂时遮蔽'了。",
      origin: "亚里士多德在《尼各马可伦理学》第七卷中详细讨论了akrasia。苏格拉底认为'无人有意作恶',亚里士多德论证了苏格拉底错了——人可以知道却做不到。",
    ...
    flavorText: "你知道不该贪暴击——但那数字太好看了。",
    dropWeight: 10,
  },

  // ═══ 白板之环 (ring/common) ═══
  {
    templateId: "tabula_rasa_ring",
    name: "白板之环",
    rarity: "common",
    slot: "ring",
    stageRange: [1, 15],
    baseStats: { luck: 4, maxHp: 10 },
    effects: [],
    concept: findConcept_provide('tabula_rasa_ring', {
      id: "tabula_rasa", term: "白板(Tabula Rasa)", termEn: "Tabula Rasa / Blank Slate",
      school: "经验论 / 洛克", field: "哲学",
      summary: "洛克在《人类理解论》中反驳了'天赋观念'论。心灵是一块'白板'——刚出生时上面什么都没有,所有知识都来自经验。经验有两个来源:感觉(对外部世界的感知)和反省(对心灵自身活动的感知)。简单观念像原子一样被感觉写入白板,复杂观念则是心灵对这些简单观念的组合、比较和抽象。",
      origin: "约翰·洛克(John Locke, 1632-1704)在《人类理解论》(1689)中系统阐述了经验主义认识论。'白板'这个比喻可追溯到亚里士多德,洛克将其发展为完整的经验论纲领。",
    ...
    flavorText: "空白的指环——经验将决定它最终的样子。",
    dropWeight: 35,
  },

  // ═══ 存在先于本质之环 (ring/magic) ═══
  {
    templateId: "sartre_existence_ring",
    name: "存在先于本质之环",
    rarity: "magic",
    slot: "ring",
    stageRange: [10, 25],
    baseStats: { atk: 8, luck: 5, crit: 0.03 },
    effects: [],
    concept: findConcept_provide('sartre_existence_ring', {
      id: "existence_precedes_essence", term: "存在先于本质", termEn: "Existence Precedes Essence",
      school: "存在主义 / 萨特", field: "哲学",
      summary: "萨特在《存在主义是一种人道主义》中提出了存在主义的第一原则:存在先于本质。人首先存在于世界中,遭遇自己,在世界中涌现——然后才定义自己。没有上帝赋予的'人性',没有预定的命运。你就是你所做的事的总和。这意味着你是彻底自由的,也是彻底负责任的——'人被判定为自由'。",
      origin: "让-保罗·萨特(Jean-Paul Sartre, 1905-1980)在《存在与虚无》(1943)和《存在主义是一种人道主义》(1946)中系统阐述。这一原则是对传统本质主义(从柏拉图到基督教神学)的根本反转。",
    ...
    flavorText: "你的本质由你的选择定义——这枚戒指就是你选择的证明。",
    dropWeight: 30,
  },

  // ═══ 中庸之环 (ring/rare) ═══
  {
    templateId: "golden_mean_ring",
    name: "中庸之环",
    rarity: "rare",
    slot: "ring",
    stageRange: [18, 35],
    baseStats: { atk: 6, def: 6, maxHp: 20, luck: 3 },
    effects: [],
    concept: findConcept_provide('golden_mean_ring', {
      id: "golden_mean", term: "中庸之道(Golden Mean)", termEn: "Golden Mean / Mesotes",
      school: "伦理学 / 亚里士多德", field: "哲学",
      summary: "亚里士多德提出：美德是两种恶之间的中道。勇敢是怯懦和鲁莽之间的中点；慷慨是吝啬和挥霍之间的中点。但这个中点不是算术平均——需要实践智慧(phronesis)来判断。美德是一种'习性'(hexis)，需要通过反复练习来培养。",
      origin: "亚里士多德在《尼各马可伦理学》第二卷中系统阐述了中道学说。",
